                    ...
                    <div className="profile__block">
                        ...
                        <div className="profile__info">
                            ...
                            <h2 className="profile__email title">
                                Ваш эл.почта: <span>{user.email === null ? 'Электронный почта скрыто' : user.email}</span>
                            </h2>
                            <div className="profile__line"></div>
                            <h2 className="profile__company title">Ваше компания:
                                <span>{user.company === null ? 'Компания не указано' : user.company}</span>
                            </h2>
                            <div className="profile__line"></div>
                            <h2 className="profile__location title">Ваше место положение:
